...
class Controller extends BaseController
{
    ...
    public function getBucketImageUrl($uuid,$image_name,$type){
        ...
        if($type == 'company') {
            return url('https://'.env('AWS_COMPANY_BUCKET').'.s3.us-east-2.amazonaws.com/company/'.$uuid.'/'.$image_name);
        }else if($type == 'employer'){
            return url('https://'.env('AWS_COMPANY_BUCKET').'.s3.us-east-2.amazonaws.com/employer/'.$uuid.'/'.$image_name);
        }else{
            return url('https://'.env('AWS_BUCKET').'.s3.us-east-2.amazonaws.com/'.$uuid.'/'.$image_name);
        }
    }    
}
