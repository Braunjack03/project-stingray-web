                ...
                <div class="pt-32 pb-12 md:pt-40 md:pb-20">
                    <v-row>
                        <v-col cols="12" md="3" sm="4" class="sm:pt-16">
                            <Sidebar :company_uuid="''" :plan="plan_name" :job_posts_count="job_posts_count" />
                        </v-col>
                        ...
                        <v-col cols="12" md="9" sm="8" class="pl-3 md:pl-8">
                            ...
                            <div class="max-w-2xl">
                                ...
                                <v-form ref="form" class="max-w-xl form-outer-wrapper">
                                    ...
                                    <div class="flex flex-nowrap mb-3">
                                        <div class="w-full px-3 form-file-upload">
                                            <label class="block mb-1 text-lg font-medium text-gray-700">Company Logo (Recommended 500px x 500px)
                                              </label>
                                            <v-file-input v-model="user.logo_image_url" class="
                                                  w-full
                                                  text-gray-700
                                                  fileUpload
                                                  form-input
                                                  input-field-outer
                                                " accept="image/*" outlined dense @change="onFileChange" />
                                        </div>
                                        ...
                                        <div class="w-full px-3">
                                          ...
                                          <div class="flex flex-wrap mb-3">
                                            <div class="w-full px-3">
                                              ...
                                              <div
                                                v-if="
                                                  $v.local_employees.$error &&
                                                  !$v.local_employees.required
                                                "
                                                class="text-lg text-red-500"
                                              >
                                          ...
                                          <div class="flex flex-wrap mb-3">
                                            <div class="w-full px-3">
                                              <label
                                                class="block mb-1 text-lg font-medium text-gray-700"
                                                >Number of global employees</label
                                              >
                                              <v-text-field
                                          ...
                                          <div class="flex flex-wrap mb-3">
                                            <div class="w-full px-3">
                                              ...
                                              />
                                              <div v-if="errors.website_url" class="mt-2 error">
                                                {{ errors.website_url }}
                                              </div>
                                            </div>
                                          </div>
                                          ...
                                          <div class="flex flex-nowrap mb-3">
                                            <div class="w-full px-3 form-file-upload">
                                              <label
                                                class="block mb-1 text-lg font-medium text-gray-700"
                                                >Featured Image (Recommended 500px x 500px)
                                              </label>
                                            <v-file-input v-model="user.featured_image_url" class="
                                                  w-full
                                                  text-gray-700
                                                  fileUpload
                                                  form-input
                                                  input-field-outer
                                                " accept="image/*" outlined dense @change="onFeaturedFileChange" />
                                        </div>
                                        <div v-if="user.featured_image_src" class="w-full px-3 form-avataar">
                                            <v-icon v-if="user.featured_image_src" color="gray darken-2" class="ml-auto" @click="removeFeaturedImage()">
                                                mdi-close-circle
                                            </v-icon>
                                    ...
                                    <div class="flex flex-wrap mb-3">
                                        <div class="w-full px-3">
                                            <label class="block mb-1 text-lg font-medium text-gray-700">Company Mission</label
                                              ...
                                              />
                                              <div v-if="errors.mission" class="mt-2 error">
                                                {{ errors.mission }}
                                              </div>
                                            </div>
                                          </div>
                                          ...
                                          <div class="flex flex-wrap mb-3">
                                            <div class="w-full px-3">
                                              <label
                                                class="block mb-1 text-lg font-medium text-gray-700"
                                                >Company Description<span class="text-red-600"
                                                  >*</span
                                                ></label
                                              >
                                              <v-textarea
                                        ...
                                        <div class="w-full px-3">
                                            <label class="block mb-1 text-lg font-medium text-gray-700">Address</label
                                              ...
                                              <v-text-field
                                                ...
                                                placeholder="Address"
                                              />
                                              <div v-if="errors.street_addr_1" class="mt-2 error">
                                          ...
                                          <div class="flex flex-wrap mb-3">
                                            <div class="w-full px-3">
                                              ...
                                              />
                                              <div v-if="errors.street_addr_2" class="mt-2 error">
                                          ...
                                          <div class="flex flex-wrap mb-3">
                                            <div class="w-full px-3">
                                              ...
                                              <v-text-field
                                                ...
                                                placeholder="City"
                                              />
                                              <div v-if="errors.city" class="mt-2 error">
                                                {{ errors.city }}
                                              </div>
                                            </div>
                                          </div>
                                          ...
                                          <div class="flex flex-wrap mb-3">
                                            ...
                                            <v-row>
                                                <v-col class="d-flex" cols="12">
                                                    <v-select v-model="user.state_abbr" :items="items" label="State" class="
                                                      w-full
                                                      text-gray-700
                                                      form-input
                                                      input-field-outer
                                                ...
                                                <div v-if="errors.state_abbr" class="mt-2 error">
                                                    {{ errors.state }}
                                                </div>
                                            </v-row>
                                        </div>
                                    ...
                                    <div class="flex flex-wrap mb-3">
                                        <div class="w-full px-3">
                                            <label class="block mb-1 text-lg font-medium text-gray-700">Zipcode
                                              </label>
                                            <v-text-field v-model="user.postcode" class="
                                                  w-full
                                                  text-gray-700
                                                  form-input
                                                  input-field-outer
                                                " placeholder="Zipcode" />
                                            <div v-if="errors.postcode" class="mt-2 error">
                                                {{ errors.postcode }}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex flex-wrap mb-3">
                                        <div class="w-full px-3">
                                            <label class="block mb-1 text-lg font-medium text-gray-700">LinkedIn</label
                                              ...
                                              />
                                              <div v-if="errors.linkedin_user" class="mt-2 error">
                                          ...
                                          <div class="flex flex-wrap mb-3">
                                            <div class="w-full px-3">
                                              ...
                                              />
                                              <div v-if="errors.facebook_user" class="mt-2 error">
                                          ...
                                          <div class="flex flex-wrap mb-3">
                                            <div class="w-full px-3">
                                              ...
                                              <v-text-field
                                                ...
                                                placeholder="Twitter"
                                              />
                                              <div v-if="errors.twitter_user" class="mt-2 error">
                                                {{ errors.twitter_user }}
                                              </div>
                                            </div>
                                          </div>
                                          ...
                                          <div class="flex flex-wrap mb-3">
                                            <div class="w-full px-3">
                                              ...
                                              />
                                              <div v-if="errors.instagram_user" class="mt-2 error">
...
export default {
    ...
    methods: {
        ...
        onFeaturedFileChange() {
            this.user.featured_image_src = URL.createObjectURL(
                this.user.featured_image_url
            );
        },
        onHeaderFileChange() {
