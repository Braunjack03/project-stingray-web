                        ...
                        <v-form ref="form">
                            ...
                            <div class="flex flex-wrap -mx-3 mb-4">
                                <div class="w-full px-3">
                                    ...
                                    <v-text-field v-model="name" class="form-input input-field-outer w-full text-gray-500" placeholder="Job Title" :class="{ 'error--text': $v.name.$error }" @input="$v.name.$touch()" @blur="$v.name.$touch()" required></v-text-field>
                                ...
                                <div class="w-full px-3">
                                    ...
                                    <v-row>
                                        <v-col class="d-flex" cols="12">
                                            <v-select v-model='location_id' item-text="name" item-value="id" :items="locations" label="Location" class="form-input input-field-outer w-full text-gray-500" dense solo></v-select>
                                        </v-col>
                            ...
                            <div class="flex flex-wrap -mx-3 mb-4">
                                <div class="w-full px-3">
                                    ...
                                    <v-row>
                                        <v-col class="d-flex" cols="12">
                                            <v-select v-model='job_cat_id' item-text="name" item-value="id" :items="job_categories" label="Job Category" :class="{ 'error--text': $v.job_cat_id.$error }" class="form-input input-field-outer w-full text-gray-500" dense solo></v-select>
