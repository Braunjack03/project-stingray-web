          ...
          <div class="max-w-6xl mx-auto px-4 sm:px-6">
            ...
            <div class="max-w-xl mx-auto">
                ...
                <v-form ref="form" >
                    ...
                    <v-text-field v-model="user.mission" class="form-input input-field-outer w-full text-gray-300" required></v-text-field>
                    ...
                    <v-text-field v-model="user.linkedin_user" class="form-input input-field-outer w-full text-gray-300" required></v-text-field>
                    ...
                    <v-text-field v-model="user.facebook_user" class="form-input input-field-outer w-full text-gray-300" required></v-text-field>
                    ...
                    <v-text-field v-model="user.twitter_user" class="form-input input-field-outer w-full text-gray-300" required></v-text-field>
                    ...
                    <v-text-field v-model="user.instagram_user" class="form-input input-field-outer w-full text-gray-300" required></v-text-field>
