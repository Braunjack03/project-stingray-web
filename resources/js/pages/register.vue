            ...
            <div class="max-w-sm mx-auto">
              <div class="flex items-center my-6">
                ...
                <div class="border-t border-gray-700 border-dotted flex-grow ml-3" aria-hidden="true"></div>
                    ...
                    <p v-if="errors.message" class="mt-2 error">{{ errors.message }}</p>
              ...
              <form>
                <div class="flex flex-wrap -mx-3 mb-4">
                  <div class="w-full px-3">
                    ...
                    <v-text-field v-model="form.email" class="form-input w-full text-gray-300" placeholder="you@yourcompany.com"  :rules="form.emailRules" required></v-text-field>
                ...
                <div class="flex flex-wrap -mx-3 mb-4">
                  <div class="w-full px-3">
                    <label class="block text-gray-300 text-sm font-medium mb-1" for="password">Password <span class="text-red-600">*</span></label>
                     ...
                     <v-text-field v-model="form.password" :rules="form.passwordRules" type="password"  class="form-input w-full text-gray-300" placeholder="Password (at least 10 characters)" autocomplete required></v-text-field>
                ...
                <div class="flex flex-wrap -mx-3 mt-6">
                  <div class="w-full px-3">
                    <v-btn :disabled="!valid" class="btn text-white bg-purple-600 hover:bg-purple-700 w-full" @click="submit()" >Sign up</v-btn>
                  </div>
                </div>
              </form>
