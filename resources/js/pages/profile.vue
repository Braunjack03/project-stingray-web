        ...
        <v-container>
            ...
            <br/>
                ...
                <v-form ref="form" v-model="valid" lazy-validations >
                    ...
                    <v-text-field v-model="form.current_job_title" required></v-text-field>
                    <div v-if="errors.current_job_title" class="mt-2 error">{{ errors.current_job_title }}</div>
                    
                    <label>Short Bio</label>
                    <v-text-field v-model="form.shortbio" required></v-text-field>
                    <div v-if="errors.shortbio" class="mt-2 error">{{ errors.shortbio }}</div>


                    <h3>Social Links</h3>  

                     <label>LinkedIn</label>
                    <v-text-field v-model="form.linkedin" required></v-text-field>
                    <div v-if="errors.linkedin" class="mt-2 error">{{ errors.linkedin }}</div>

                     <label>Github</label>
                    <v-text-field v-model="form.github" required></v-text-field>
                    ...
                    <v-file-input show-size counter outlined dense v-model="form.current_resume"></v-file-input>
  ...
  export default {
    ...
    props: {
     ...
     methods: {
      ...
      submit() {
            this.$inertia.post('/profile', this.form );
