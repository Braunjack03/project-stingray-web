                ...
                <div class="max-w-6xl mx-auto px-4 sm:px-6">
                    <div class="companyDetail--title">
                        <h2 class="post-title mb-0 text-gray-700">
                            {{ data.name }}
                            <v-btn v-if="data.unclaimed == 1" v-on:click="claimProfile(data.uuid)" class="link-text" text>(Claim this Profile)</v-btn>
                        </h2>
                     ...
                     <div v-if="$page.props.flash.message && hide == 0" class="verifyEmailText verifyclaimText" >
                ...
                <div class="max-w-6xl mx-auto px-4 sm:px-6">
                    ...
                    <div class="companyDetail">
                        <div class="companyLogo">
                            <v-img :src="(data.logo_image_url) ? data.logo_image_url : '/images/default-logo.png'"></v-img>
                        </div>
                        ...
                        <path fill-rule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clip-rule="evenodd" />
                                        ...
                                        <span class="loactionCity" v-if="data.state"><strong><span v-if="data.city" >{{ data.city }}, </span>{{ data.state }}</strong>
                                        </span>
                                    </div>
                                </v-col>
                                <v-col cols="12" sm="6" md="4">
                        ...
                        ><br />
                                    ...
                                    <a :href="data.website_url" target="_blank" class="background-transparent flex flex-wrap viewSite items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="#5d5dff">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9" />
                      </svg> View website
                      </a>
            ...
            <div class="max-w-6xl mx-auto px-4 sm:px-6 companyAbout">
                <v-row>
                    <v-col cols="12" md="6" class="pa-3 d-flex flex-column">
                        <div class="aboutImg">
                            <v-img :src="(data.featured_image_url) ? data.featured_image_url : '/images/aboutImg.jpg'"></v-img>
                        </div>
                    </v-col>
                    <v-col cols="12" md="6" class="pa-3 d-flex flex-column">
                ...
                <div class="max-w-6xl mx-auto px-4 sm:px-6 pt-4">
                    <v-row >
                        ...
                        <v-col cols="12" class="mt-5 text-center text-gray-700">
                              ...
                              <Link class="text-center underline" href="/articles">More Articles</Link>
                            </v-col>
