        ...
        <div>
          ...
          <div class="flex justify-center mb-16" data-aos="fade-up" data-aos-delay="400">
            <div class="inline-flex items-center">
              <div class="textColor font-medium mr-3">Billed Monthly</div>
              ...
              <div class="textColor font-medium ml-3">Billed Annually</div>
            </div>
          </div>
          ...
          <div class="flex flex-col lg:flex-row justify-between items-center mt-12 lg:mt-6 lg:py-8 lg:border-t lg:border-b lg:border-gray-700">
            <div class="font-medium text-lg text-gray-700 text-center lg:text-left mb-4 lg:mb-0">Expecting more than 1000 Active End Users?</div>
            <div>
